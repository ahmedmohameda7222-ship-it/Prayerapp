...
export function BottomNav() {
  ...
  return (
    <nav aria-label={t("nav.ariaLabel")} className="fixed inset-x-0 bottom-0 z-50 mx-auto h-[82px] max-w-[760px] rounded-t-[28px] bg-gradient-to-br from-[var(--color-emerald-dark)] to-[var(--color-emerald)] px-3 pt-3 shadow-[0_-8px_28px_rgba(6,43,38,0.18)]">
