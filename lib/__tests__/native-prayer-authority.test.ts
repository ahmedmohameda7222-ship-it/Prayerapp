...
describe("native prayer authority", () => {
  ...
  it.each([
    ...
    ["global notification delivery disabled", { notification_delivery_enabled: false }],
    ["prayer reminder channel disabled", { reminder_channel_enabled: false }],
    ["Adhan media channel disabled", { adhan_channel_enabled: false }],
